...
- [ ] All six `ISO_CODE_*` environment variables documented in trait doc comments: `ISO_CODE_PATH`, `ISO_CODE_BRANCH`, `ISO_CODE_REPO`, `ISO_CODE_NAME`, `ISO_CODE_PORT`, `ISO_CODE_UUID`
...
- [ ] Implement environment variable injection helper that sets all `ISO_CODE_*` and compatibility variables before calling `setup()`
